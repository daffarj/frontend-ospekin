...
export function Login() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    if (email === "admin@ospekin.ub") {
      navigate("/admin/dashboard");
      return;
    }
    if (email === "kurir@ospekin.ub") {
  ...
  return (
    <div
      className="min-h-screen bg-[#030303] flex items-center justify-center relative overflow-hidden p-4"
        ...
        <div className="bg-[#111] border border-white/8 rounded-2xl p-8">
          ...
          <div className="mt-4 pt-4 border-t border-white/5">
            <p className="text-white/20 text-xs text-center">
              Demo: gunakan admin@ospekin.ub → Admin, kurir@ospekin.ub → Kurir,
              email lain → User
            </p>
          </div>
        </div>
