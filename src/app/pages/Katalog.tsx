      ...
      <div className="pt-28 pb-20 max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-white mb-4">
            Katalog Paket Atribut Ospek
          </h1>
          <p className="text-white/40 max-w-2xl mx-auto">
            Satu paket sudah mencakup semua kebutuhan ospek kamu. Harga yang
            ditampilkan adalah estimasi.
          </p>
        </div>
        ...
        <div className="flex justify-center mb-10">
          <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-amber-500/15 border border-amber-500/30 rounded-full">
            ...
            <span className="text-amber-300 text-sm">
              Harga estimasi — belum final. Harga resmi akan diumumkan setelah
              pengumuman atribut resmi dari panitia.
            </span>
          </div>
        </div>
