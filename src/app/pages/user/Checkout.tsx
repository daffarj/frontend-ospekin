      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-5">
            <h3 className="text-gray-900 font-semibold mb-4">Ringkasan Pesanan</h3>
            <p className="text-gray-900 font-medium">Paket Standar</p>
            <p className="text-gray-500 text-sm mb-3">16 item bundle</p>

            <button onClick={() => setShowItems(!showItems)} className="flex items-center gap-1 text-indigo-600 text-sm">
            ...
            <div className="mt-4 pt-4 border-t border-gray-100 space-y-2">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-gray-800 text-right max-w-xs truncate">Jl. Veteran No. 1, Kos Mawar, Malang</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-5">
            <h3 className="text-gray-900 font-semibold mb-3">
              Punya Kode Referal? <span className="text-gray-400 text-sm font-normal">(opsional)</span>
            </h3>
            <div className="flex gap-2">
              <input
                value={referral}
                onChange={e => { setReferral(e.target.value); setReferralError(false); }}
              ...
              />
              <button onClick={applyReferral} className="px-4 py-2.5 bg-indigo-600 text-white rounded-xl text-sm hover:bg-indigo-700">
                Terapkan
              </button>
            </div>
            {referralApplied && <p className="text-emerald-600 text-sm mt-2">✓ Kode berhasil! Diskon Rp 10.000</p>}
            {referralError && <p className="text-rose-500 text-sm mt-2">Kode tidak valid atau sudah tidak aktif</p>}
          </div>

          {/* Rincian pembayaran */}
          <div className="bg-white border border-gray-200 rounded-2xl p-5">
            <h3 className="text-gray-900 font-semibold mb-4">Rincian Pembayaran</h3>
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                <span className="text-gray-700 font-medium">Total DP yang Dibayar</span>
                <span className="text-indigo-600 font-bold text-lg">Rp {total.toLocaleString("id")}</span>
              </div>
            </div>
            <div className="mt-4 p-3 bg-amber-50 border border-amber-100 rounded-xl">
              <p className="text-amber-700 text-xs">Harga estimasi. Sisa tagihan akan muncul setelah panitia rilis harga resmi.</p>
            </div>
            <p className="text-gray-400 text-xs mt-3">Pembayaran diproses melalui Dokupay — QRIS, E-Wallet, VA tersedia</p>
          </div>
          ...
          <p className="text-center text-gray-400 text-xs">
            Dengan menekan tombol ini, kamu menyetujui <span className="underline">syarat & ketentuan</span>
          </p>
        </div>
      </div>
    </div>
