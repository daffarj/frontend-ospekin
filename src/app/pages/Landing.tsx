...
import { UserPlus, ShoppingCart, Clock, Package, ShieldCheck, MapPin, ChevronDown } from "lucide-react";
...
const steps = [
  { icon: UserPlus, title: "Daftar & Isi Profil", desc: "Buat akun dengan email personal" },
  { icon: ShoppingCart, title: "Pilih Paket & Bayar DP", desc: "Pilih paket dan amankan kuota" },
  { icon: Clock, title: "Tunggu Harga Final", desc: "Panitia akan merilis harga resmi" },
  { icon: Package, title: "Lunasi & Terima Paket", desc: "Bayar sisa dan terima paket" },
];
...
const floatingShapes = [
  { width: 200, height: 80, top: "15%", left: "8%", rotate: 12, color: "rgba(99,102,241,0.15)", delay: 0 },
  { width: 140, height: 56, top: "70%", right: "5%", rotate: -15, color: "rgba(244,63,94,0.15)", delay: 1.5 },
  { width: 100, height: 40, top: "75%", left: "10%", rotate: -8, color: "rgba(139,92,246,0.15)", delay: 3 },
  { width: 80, height: 32, top: "10%", right: "15%", rotate: 20, color: "rgba(245,158,11,0.15)", delay: 2 },
  { width: 60, height: 24, top: "30%", left: "20%", rotate: -25, color: "rgba(6,182,212,0.15)", delay: 1 },
];
...
export function Landing() {
  ...
  return (
    <div className="bg-[#030303] min-h-screen text-white" style={{ fontFamily: "Inter, sans-serif" }}>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        {floatingShapes.map((shape, i) => (
          <motion.div
            ...
            animate={{ y: [0, 15, 0] }}
            transition={{ duration: 12, repeat: Infinity, delay: shape.delay, ease: "easeInOut" }}
            initial={{ opacity: 0 }}
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4 pt-20">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/8 border border-white/10 mb-8">
              ...
              <span className="text-white/60 text-sm">Atribut Resmi Ospek UB 2026</span>
            </div>
            ...
            <h1 className="mb-6 tracking-tight">
              ...
              <span
                ...
                style={{ background: "linear-gradient(135deg, #6366f1, #f43f5e)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}
              >
                Siap Hari Pertama
              </span>
            </h1>
            ...
            <p className="text-white/40 max-w-xl mx-auto mb-10 text-lg font-light leading-relaxed">
              Pesan atribut ospek Universitas Brawijaya tanpa antri.
              DP dulu, lunasi setelah harga resmi keluar.
            </p>
      ...
      <section className="py-24 bg-[#0a0a0a]">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-white">4 Langkah, Paket Sampai di Tanganmu</h2>
          </div>
          ...
          <div className="hidden md:grid grid-cols-4 gap-6 relative">
            ...
            {steps.map((step, i) => (
              ...
              >
                ...
                <h3 className="text-white font-semibold mb-1 text-base">{step.title}</h3>
      ...
      <section className="py-24 bg-[#030303]">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-6">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-3">Semua yang Kamu Butuhkan, Satu Paket</h2>
            <p className="text-white/40">Harga yang ditampilkan adalah estimasi. Harga resmi akan diperbarui panitia.</p>
          </div>

          <div className="flex justify-center mb-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-amber-500/15 border border-amber-500/30 rounded-full">
              <span className="text-amber-400 text-sm">⚠ Harga estimasi, belum final</span>
            </div>
          </div>
            ...
            {[
              ...
              >
                ...
                <div className="flex items-center gap-3 mb-1">
                  <span className="text-white font-semibold">Est. {pkg.price}</span>
      ...
      <section className="py-24 bg-[#0a0a0a]">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl sm:text-4xl font-bold text-white text-center mb-12">Kenapa Harus OSPEKIN?</h2>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { icon: ShieldCheck, title: "Pembayaran Aman", desc: "Via Dokupay, QRIS & e-wallet terpercaya" },
              { icon: MapPin, title: "Antar ke Kos", desc: "Kurir internal panitia, pantau status real-time" },
              { icon: Clock, title: "Bayar DP Dulu", desc: "Kunci kuota sekarang, lunasi setelah harga fix" },
            ].map(({ icon: Icon, title, desc }) => (
              <div key={title} className="bg-white/5 border border-white/8 rounded-2xl p-6 border-l-2 border-l-indigo-500">
      ...
      <section className="py-24 bg-[#030303]">
        <div className="max-w-3xl mx-auto px-4">
          <h2 className="text-3xl sm:text-4xl font-bold text-white text-center mb-12">Pertanyaan Umum</h2>
          <Accordion.Root type="single" collapsible className="space-y-3">
            {faqs.map((faq, i) => (
              <Accordion.Item key={i} value={String(i)} className="bg-white/5 border border-white/8 rounded-2xl overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <p className="text-white/40 text-sm">Platform pemesanan atribut ospek resmi Universitas Brawijaya.</p>
            </div>
            <div>
              <p className="text-white/60 text-sm font-medium mb-3">Quick Links</p>
              <div className="space-y-2">
                {["Katalog", "Cara Pesan", "About", "Login"].map(link => (
                  <button key={link} className="block text-white/40 text-sm hover:text-white transition-colors">{link}</button>
                ))}
              </div>
            </div>
            <div>
              <p className="text-white/60 text-sm font-medium mb-3">Hubungi Kami</p>
              <a href="https://wa.me/6281234567890" className="inline-flex items-center gap-2 px-4 py-2.5 bg-green-600 hover:bg-green-700 rounded-full text-white text-sm transition-colors">
          ...
          <div className="border-t border-white/5 pt-6 flex flex-col sm:flex-row justify-between items-center gap-2">
            <p className="text-white/30 text-xs">© 2026 OSPEKIN.UB. Platform pemesanan atribut ospek UB.</p>
          </div>
        </div>
      </footer>
    </div>
